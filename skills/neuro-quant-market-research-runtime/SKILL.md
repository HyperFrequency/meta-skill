...
description: Use when working in the neuro-quant monorepo on work on vectorized research, event-driven execution, hft backtests, and performance proof surfaces. Route to local references first, then deep-tool-wiki or 02-KB-main for full documentation.
...
Work on vectorized research, event-driven execution, HFT backtests, and performance proof surfaces.

Use this skill when the task matches one of these signals:
- convert vectorbt to nautilus
- backtest this strategy
- compare vectorbtpro and nautilus trader
- hftbacktest market microstructure
- produce a tearsheet with proof

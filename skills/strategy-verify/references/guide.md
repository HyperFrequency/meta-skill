# Strategy Verification — Complete Guide

Extended reference for the `strategy-verify` skill. SKILL.md is the lean router;
this file holds the full verification process, tolerances, troubleshooting, and
API reference.

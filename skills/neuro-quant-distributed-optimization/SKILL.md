...
description: Use when working in the neuro-quant monorepo on coordinate optuna, ray, dask, mlflow, postgresql storage, and local fan-out for long sweeps. Route to local references first, then deep-tool-wiki or 02-KB-main for full documentation.
...
Coordinate Optuna, Ray, Dask, MLflow, PostgreSQL storage, and local fan-out for long sweeps.

...
description: Use when working in the neuro-quant monorepo on maintain neuro-link, deep-tool-wiki, qmd, and byok lookup infrastructure. Route to local references first, then deep-tool-wiki or 02-KB-main for full documentation.
...
Maintain neuro-link, deep-tool-wiki, QMD, and BYOK lookup infrastructure.

Use this skill when the task matches one of these signals:
- deep-tool-wiki
- neuro-link RAG
- Qdrant or Neo4j docs ingestion
- k-dense-byok
- resource lookup with full documentation

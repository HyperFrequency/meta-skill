# The Eight Frameworks (Detail)

Full detail for each of the eight creative-thinking frameworks. SKILL.md holds the one-line summaries and routing; read the relevant section here when applying a framework.

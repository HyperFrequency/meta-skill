...
codex exec --json --ephemeral --sandbox read-only -C $HOME/Code/pi-coding-agent-sdk "<positive smoke prompt>"
codex exec --json --ephemeral --sandbox read-only -C $HOME/Code/pi-coding-agent-sdk "<negative smoke prompt>"
```
